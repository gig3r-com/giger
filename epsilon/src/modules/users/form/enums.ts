...
export const USER_COMBAT_SKILL_OPTIONS = [ '0', '1', '2', '3', '4', '5' ] as const;
export const USER_CYBERWARE_LVL_OPTIONS = [ '0', '1', '2', '3', '4', '5' ] as const;
export const USER_HACKING_LVL_OPTIONS = [ '0', '1', '2', '3' ] as const;
