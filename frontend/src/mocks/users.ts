...
import { mockCriminalRecord as mockcriminalEvents } from './criminal';
...
export const users: IUserPrivate[] = [
    {
        ...
        hackingSkills: { stat: 0 },
        confrontationVsNegotiation: { stat: 0 },
        cowardVsFighter: { stat: 0 },
        talkativeVsSilent: { stat: 0 },
        thinkerVsDoer: { stat: 0 },
        roles: [UserRoles.ADMIN],
        revealCodes: [],
        faction: Factions.BORDELLO,
        combatSkill: { stat: 0 },
        criminalEvents: mockcriminalEvents,
        medicalEvents: mockMedicalHistory,
        favoriteUserIds: [],
        active: true,
        privateRecords: [],
        meta: [],
        ...
        subnetworkName: '',
        reputation: {
            [GigCategoryNames.KILLER]: 2345,
            [GigCategoryNames.FIXER]: 23432,
            [GigCategoryNames.HACKING]: 78774,
            [GigCategoryNames.WELLBEING]: 2311
        },
        vibe: Vibe.DIGIEVO,
        vibeFunction: 'Hacker',
    ...
    },
    {
        ...
        hackingSkills: { stat: 3 },
        confrontationVsNegotiation: { stat: 0 },
        cowardVsFighter: { stat: 1 },
        talkativeVsSilent: { stat: 4 },
        thinkerVsDoer: { stat: 0 },
        roles: [],
        faction: Factions.BORDELLO,
        revealCodes: [],
    ...
    },
    {
        ...
        assets: ['GIGER_SYSTEM'],
        hackingSkills: { stat: 3 },
        confrontationVsNegotiation: { stat: 4 },
        cowardVsFighter: { stat: 4 },
        talkativeVsSilent: { stat: 4 },
        thinkerVsDoer: { stat: 0 },
        roles: [],
        faction: Factions.BORDELLO,
